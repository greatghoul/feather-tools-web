            ...
            <div className="col-lg-6">
                <div className="card h-100">
                    ...
                    <div className="card-body">
                        <ol>
                            <li><T k="tip-calculator/how_to_use/step1" /></li>
                            <li><T k="tip-calculator/how_to_use/step2" /></li>
                            <li><T k="tip-calculator/how_to_use/step3" /></li>
                            <li><T k="tip-calculator/how_to_use/step4" /></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div className="card h-100">
                    ...
                    <div className="card-body">
                        <ul>
                            ...
                            <li><T k="tip-calculator/features/privacy" /></li>
                        </ul>
                    </div>
                </div>
            </div>

...
<>
        ...
        <StoreContext.Provider value={store}>
            <div className="clean-urls">
                <SettingCard onSubmit={handleCleanUrls} onClear={handleClear} />

                <OutputCard cleanedUrls={cleanedUrls} copyButtonRef={copyButtonRef} onCopy={handleCopy} onDownload={handleDownload} />
            </div>
...
export default BatchUrlCleaner;

...
import AdjustSetting, { DEFAULT_ADJUST_SETTING } from '@/components/AdjustSetting.js';
        ...
        <div class="card mb-3">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ${renderNavItem('images', getText('image-adjust/input/images'), 'images')}
                    ${renderNavItem('settings', getText('image-adjust/input/settings'), 'sliders')}
                </ul>
            </div>
            ${renderTabContent()}
        </div>

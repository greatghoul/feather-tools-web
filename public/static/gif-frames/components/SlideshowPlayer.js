            ...
            <div class="slideshow-content" onClick=${(e) => e.stopPropagation()}>
                <div class="slideshow-header">
                    <span class="slideshow-title">
                        ${getText('gif-frames/slideshow/title')}
                    </span>
                    <button
                        class="btn btn-sm btn-close btn-close-white"
                        onClick=${onClose}
                        aria-label=${getText('gif-frames/button/close')}
                    ></button>
                </div>
                ...
                <div class="slideshow-info">
                    <span>
                        ${getText('gif-frames/slideshow/frame')}
                ...
                <div class="slideshow-controls">
                    <button
                        ...
                        onClick=${handlePrev}
                        title=${getText('gif-frames/slideshow/prev')}
                    >
                    ...
                    >
                        ...
                        <span class="ms-1">
                            ${isPlaying
                                ? getText('gif-frames/slideshow/pause')
                                : getText('gif-frames/slideshow/play')}
                        </span>
                    </button>
                    <button
                        class="btn btn-light slideshow-nav-btn"
                        onClick=${handleNext}
                        title=${getText('gif-frames/slideshow/next')}
                    >
                    ...
                    <div class="d-flex align-items-center gap-2">
                        <div class="form-check form-switch m-0">
                            ...
                            <label class="form-check-label text-white small" for="slideshow-loop">
                                ${getText('gif-frames/slideshow/loop')}
                            </label>
                        </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                        <label class="text-white small mb-0">
                            ${getText('gif-frames/slideshow/duration')}
                        </label>
                        <input
                            type="range"

...
const App = () => {
    ...
    const handleGenerate = (settings) => {
        ...
        new ChartBuilder(canvas, {
            ...settings,
            labels: {
                sleep: t('sleep-chart/label/sleep'),
                wake: t('sleep-chart/label/wake'),
                title: t('sleep-chart/chart/title'),
                days: [
                    t('common/week/sun'),
                    t('common/week/mon'),
                    t('common/week/tue'),
        ...
        <div>
            ...
            <div className="card mb-4">
                <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">{t('sleep-chart/chart/chart')}</h5>
                    <div className="actions">
                        <button className="btn btn-outline-secondary me-2" onClick={handleDownload}>
                            <i className="bi bi-download me-1"></i>{t('sleep-chart/button/download')}
                        </button>

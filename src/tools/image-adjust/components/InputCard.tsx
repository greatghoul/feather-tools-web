...
import AdjustSetting, { DEFAULT_ADJUST_SETTING } from '../components/AdjustSetting';
...
<>
                ...
                <AdjustSetting setting={formSetting} onChange={handleSettingChange} />
        ...
        <div className="card mb-3">
            <div className="card-header">
                <ul className="nav nav-tabs card-header-tabs">
                    {renderNavItem('images', t('image-adjust/input/images'), 'images')}
                    {renderNavItem('settings', t('image-adjust/input/settings'), 'sliders')}
                </ul>
            </div>
            {renderTabContent()}
        </div>

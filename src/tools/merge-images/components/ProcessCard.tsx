    ...
    const mergeImages = () => {
        ...
        Promise.all(promises)
            .then(loadedImages => {
                ...
                const finalImageWidths: number[] = [];
                const finalImageHeights: number[] = [];
            ...
            .catch(error => {
                ...
                alert(t('merge-images/error/process_failed'));
                setIsProcessing(false);
            });
    };
...
<>
    ...
    const renderTabContent = () => {
        ...
        const cardBodyStyle = isHorizontal ? { overflowX: 'auto' as const } : {};
...
<>
            ...
            <div className="card-body" style={cardBodyStyle}>
                <div className="text-center">
                    <canvas ref={canvasRef} className={canvasClass} style={canvasStyle} {...({ alt: 'Merged Result' } as any)}></canvas>
                    {isProcessing ? (
<>
                        ...
                        <div className="d-flex justify-content-center align-items-center py-5">
                            ...
                            <span className="ms-2">{t('merge-images/status/processing')}</span>
                        </div>
...
<>
                        ...
                        <p className="text-muted text-center py-5">{t('merge-images/status/click_to_process')}</p>
...
<>
            ...
            <div className="card-body border-bottom">
                <div className="row">
                    <div className="col-6">
                        <small className="text-muted">{t('merge-images/label/direction')}</small>
                        <div className="fw-bold">{direction === 'horizontal' ? t('merge-images/direction/horizontal') : t('merge-images/direction/vertical')}</div>
                    </div>
                    <div className="col-6">
                        <small className="text-muted">{t('merge-images/label/final_dimensions')}</small>
                        <div className="fw-bold">{finalWidth}px × {finalHeight}px</div>
                    </div>
                </div>
            </div>
        ...
        <div className="card mb-3">
            <div className="card-header d-flex justify-content-between align-items-center">
                <ul className="nav nav-tabs card-header-tabs">
                    {renderNavItem(t('merge-images/tab/result'), 'grid-1x2-fill')}
                </ul>
                <button className="btn btn-primary btn-sm" onClick={mergeImages} disabled={!images || images.length === 0}>
                    {t('merge-images/button/merge')}
                </button>
            </div>
            {renderSettingsInfo()}
            {renderTabContent()}
...
<>
                ...
                <div className="card-footer text-center py-3">
                    <button className="btn btn-success" onClick={downloadImage}>
                        ...
                        {t('merge-images/button/download')}
                    </button>
                </div>

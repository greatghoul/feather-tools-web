                ...
                <ul class="nav nav-tabs card-header-tabs">
                    <li class="nav-item">
                        <a 
                            ...
                            title=${getText('image-split/input/upload')}
                        >
                            <i class="bi bi-upload"></i>
                            <span class="ms-1">${getText('image-split/input/upload')}</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a 
                            ...
                            title=${getText('image-split/input/settings')}
                        >
                            <i class="bi bi-gear"></i>
                            <span class="ms-1">${getText('image-split/input/settings')}</span>
                        </a>
                    </li>
                </ul>
            </div>

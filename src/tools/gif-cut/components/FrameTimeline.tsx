            ...
            <div className="card-body">
                <div className="d-flex justify-content-between align-items-center mb-2">
                    <span className="small text-muted">
                        {t('gif-cut/timeline/frame_count').replace('{count}', totalFrames)}
                    </span>
                    <span className="small text-muted">
                        {t('gif-cut/timeline/frame')} {startFrame + 1} - {endFrame + 1}
                        ({endFrame - startFrame + 1})
                    </span>
                </div>
                <div ref={timelineRef} className="timeline-bar position-relative" style={{ height: '60px', background: '#f0f0f0', borderRadius: '6px', overflow: 'hidden', cursor: 'pointer' }}>
                    <div className="d-flex h-100" style={{ gap: '1px' }}>
...
<>
                    ...
                    <div className="position-absolute top-0 h-100" style={{
                            left: startPercent + '%',
                    ...
                    <div className="timeline-handle position-absolute top-0 start-0 h-100 d-flex align-items-center" style={{
                            left: startPercent + '%',
                    ...
                    <div className="timeline-handle position-absolute top-0 h-100 d-flex align-items-center" style={{
                            left: endPercent + '%',
                            transform: 'translateX(-50%)',
                            cursor: 'ew-resize',
                            zIndex: 10,
...
<>
                    ...
                    <div className="text-center mt-1">
                        <small className="text-muted">
                            {t('gif-cut/timeline/frame')} {hoverFrame + 1}
                        </small>
                    </div>

...
import RoundCornerSetting, { DEFAULT_ROUND_CORNER_SETTING } from '@/components/RoundCornerSetting.js';
        ...
        <div class="card mb-3">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ${renderNavItem('images', getText('image-round-corner/input/images'), 'images')}
                    ${renderNavItem('settings', getText('image-round-corner/input/settings'), 'gear')}
                </ul>
            </div>
            ${renderTabContent()}
        </div>

...
const App = () => {
    ...
    const handleLoadExample = () => {
        setInputText(t('text-to-speech/example'));
    };
...
<>
        ...
        <div className="text-to-speech-container">
            <div className="row g-4">
                ...
                <div className="col-12">
                    <ControlsCard onPlay={handlePlay} onStop={handleStop} isSpeaking={isSpeaking} rate={rate} onRateChange={handleRateChange} pitch={pitch} onPitchChange={handlePitchChange} voiceIndex={voiceIndex} onVoiceChange={handleVoiceChange} voices={voices} voicesReady={voicesReady} commonVoiceIndices={commonVoiceIndices} supported={supported} paragraphs={paragraphs} currentParagraph={currentParagraph} estimatedDuration={estimatedDuration} />
                </div>
            </div>
        </div>

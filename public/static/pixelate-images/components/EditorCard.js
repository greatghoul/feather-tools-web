...
const EditorCard = ({ image, settings, onDownload }) => {
    ...
    const pixelationLayerRef = useRef(null);
    ...
    return html`
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="btn-toolbar" role="toolbar" style="gap: 0.5rem;">
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn btn-outline-danger" onClick=${clearPixelations} title=${getText('pixelate-images/button/clear_pixelations')}><i class="bi bi-eraser"></i></button>
                    </div>
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn ${tool === 'square' ? 'btn-primary' : 'btn-outline-secondary'}" onClick=${() => setTool('square')} title=${getText('pixelate-images/button/square')}><i class="bi bi-square"></i></button>
                        <button type="button" class="btn ${tool === 'circle' ? 'btn-primary' : 'btn-outline-secondary'}" onClick=${() => setTool('circle')} title=${getText('pixelate-images/button/circle')}><i class="bi bi-circle"></i></button>
                        <button type="button" class="btn ${tool === 'brush' ? 'btn-primary' : 'btn-outline-secondary'}" onClick=${() => setTool('brush')} title=${getText('pixelate-images/button/brush')}><i class="bi bi-brush-fill"></i></button>
                    </div>
                    ${tool === 'brush' && html`
                        <${InputNumber} 
                            value=${brushSize} 
                ...
                <button class="btn btn-outline-success btn-sm" onClick=${handleLocalDownload} title=${getText('pixelate-images/button/download')}><i class="bi bi-download"></i></button>
            </div>
            <div 
                class="card-body p-0 d-flex justify-content-center align-items-center bg-light" 
                style=${{
                    'min-height': '200px', 
                    'position': 'relative',
            ...
            >
                <div ref=${konvaContainerRef} class=${konvaWrapperStyle} style=${{width: `${dimensions.width}px`, height: `${dimensions.height}px`}}></div>
            </div>
        </div>
    `;
};

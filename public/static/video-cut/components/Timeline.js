        ...
        <div class="card">
            <div class="card-body">
                <div style=${{ position: 'relative' }}>
                    ...
                    >
                        ${thumbnails ? html`
                            <div class="position-absolute top-0 bottom-0 start-0 end-0"
                                ...
                                ${thumbnails.list.map((url, i) => html`
                                    <div style=${{
                                        flex: '1 0 0',
                                        minWidth: 0,
                                        background: '#111',
                        ...
                        <div
                            ...
                            onTouchStart=${handleBlockMouseDown}
                        ></div>

                        <div
                            class="timeline-handle position-absolute top-0"
                            style=${{
                                left: startPct + '%',
                                width: '14px',
                                height: '100%',
                        ...
                        <div class="timeline-time-label position-absolute" style=${{
                            left: startPct + '%',
                            bottom: '-20px',
                            transform: 'translateX(-50%)',
                            fontSize: '11px',
                    ...
                    ${hoverThumbUrl ? html`
                        <div class="timeline-hover-preview"
                            style=${{
                                position: 'absolute',
                                left: hoverX + 'px',
                                bottom: '100%',
                ...
                <div class="position-relative" style=${{ height: '20px', marginTop: '22px' }}>
                    ${ticks.map(t => {

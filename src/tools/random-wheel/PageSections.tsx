        ...
        <div className="col-lg-6">
            <div className="card h-100">
                ...
                <div className="card-body">
                    <ol className="mb-0">
                        <li><T k='random-wheel/how_to_use/step1' /></li>
                        <li><T k='random-wheel/how_to_use/step2' /></li>
                        <li><T k='random-wheel/how_to_use/step3' /></li>
                        <li><T k='random-wheel/how_to_use/step4' /></li>
                    </ol>
                </div>
            </div>
        </div>

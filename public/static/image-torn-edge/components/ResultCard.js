...
import ImageTornEdge from '@/services/ImageTornEdge.js';
...
const BlankResult = () => html`
    <div class="card-body text-center">
        <div class="text-muted">
            ...
            <p class="mt-2 fw-semibold">${getText('image-torn-edge/result/not_processed')}</p>
            <small class="text-muted">${getText('image-torn-edge/result/upload_hint')}</small>
        </div>
    </div>
`;
        ...
        return html`
            <div class="card-body text-center ${index % 2 === 0 ? '' : 'bg-light'}">
                ...
                >
                    ...
                    ${getText('image-torn-edge/result/download')}
                </button>
            </div>
        `;
    }
        ...
        <div class="card mb-3">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                >
                    ...
                    ${getText('image-torn-edge/result/process_images')}
                </button>
                ...
                >
                    <i class="bi bi-download me-1"></i>
                    ${getText('image-torn-edge/result/download_all')}
                </button>
            </div>

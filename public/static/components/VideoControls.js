...
const VideoControls = ({ videoRef, currentTime, duration, isPlaying, startTime, endTime }) => {
    ...
    return html`
        <div class="video-controls d-flex align-items-center gap-2 px-3 py-2">
            <button
            ...
            <div
                class="video-progress-bar position-relative flex-grow-1"
                ref=${barRef}
            ...
            >
                ...
                ${hasSelection && endPct > startPct ? html`
                    <div
                        class="position-absolute"
                        style=${{
                            left: startPct + '%',
            ...
            <span
                ...
                style=${{ minWidth: '90px', textAlign: 'right', whiteSpace: 'nowrap', fontVariantNumeric: 'tabular-nums' }}
            >
